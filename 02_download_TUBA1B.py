...
meta_df = pd.read_csv(r"assest_csv\smaller_metadata.csv")
...
data_TUBA1B.to_csv(r"assest_csv\select_TUBA1B.csv", index=False)
...
data_TUBA1B_sample.to_csv(r"assest_csv\select_TUBA1B_sample.csv", index=False)
